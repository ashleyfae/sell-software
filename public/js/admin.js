...
document.addEventListener('DOMContentLoaded', function () {
  var licensePeriod = document.getElementById('license_period');
  var licensePeriodUnit = document.getElementById('license_period_unit');

  // toggle license period when unit is lifetime
  if (licensePeriod && licensePeriodUnit) {
    licensePeriodUnit.addEventListener('change', function (e) {
  ...
  var formsWithConfirmations = document.querySelectorAll('form.delete');
  if (formsWithConfirmations) {
    formsWithConfirmations.forEach(function (form) {
